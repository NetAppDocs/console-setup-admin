...
| Add, edit, or delete user activity agent | Yes | No
| Add, modify, or delete data collector | Yes | No
...
| Get full list of impacted files in user activity event | Yes | No 
