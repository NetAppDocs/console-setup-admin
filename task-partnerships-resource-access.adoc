...
You can manage roles for members of partner organizations in the same way that you do for your own. However, not all roles are available to partnership users.  You can assign following roles to partner users:
