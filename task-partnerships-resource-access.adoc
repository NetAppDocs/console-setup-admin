...
= Provide resource access to partnership users in NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
. Select the actions menu image:icon-action.png[an icon with three vertical dots] next to the established partnership that you want to view and select *View details*.
+ 
