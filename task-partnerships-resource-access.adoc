...
You can assign the following roles to partner users:
...
* link:reference-iam-predefined-roles.html[Data Classification viewer]
...
* link:reference-iam-ransomware-roles.html[Ransomware Resilience admin]
* link:reference-iam-ransomware-roles.html[Ransomware Resilience viewer]
* link:reference-iam-ransomware-roles.html#user-behavior-roles[Ransomware Resilience user behavior admin]
* link:reference-iam-ransomware-roles.html#user-behavior-roles[Ransomware Resilience user behavior viewer]
