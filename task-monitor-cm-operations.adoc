...
[cols="20,60",options="header",width="85%"]
|===
...
[NOTE]
====
* The Console sends email notifications for the agent, licenses and subscriptions, NetApp Copy and Sync, NetApp Backup and Recovery and NetApp Ransomware Resilience.
