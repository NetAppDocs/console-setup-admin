...
For details, refer to the https://docs.netapp.com/us-en/storage-management-fsx-ontap/requirements/task-setting-up-permissions-fsx.html[the Console documentation for Amazon FSx for ONTAP^]
...
You need to create a Console agent before you can configure a subscription. link:concept-agents.html#agent-installation[Learn how to create a Console agent].
