...
| link:reference-iam-ransomware-roles.html[Ransomware Resilience user behavior admin] | pass:[RANSOMWARE_RESILIENCE_USER<wbr>_BEHAVIOR_ADMIN] | Configure, manage, and view suspicious user behavior detection, alerts, and monitoring in Ransomware Resilience. 
