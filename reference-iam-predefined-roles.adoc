...
| | link:reference-iam-licenses-subscriptions.html[License and subscription viewer] | Users with the License and subscription view role can view direct licenses and marketplace subscriptions for the NetApp Console and affiliated data services. 
