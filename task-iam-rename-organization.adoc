...
= Rename your NetApp Console organization and get IDs
:hardbreaks:
:nofooter:
:icons: fontapp
:linkattrs:
...
[.lead]
Your NetApp Console organization has a name and an ID. You can choose a name for your organization to help identify it. You may also need to know the organization ID to use for API calls.

== Rename your organization

You can rename your organization. This is helpful if you support more than one organization.
...
+
image:screenshot-iam-edit-organization.png[A screenshot of Organization page that shows the actions icon and the Edit organization option.]
