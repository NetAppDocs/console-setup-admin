...
[.lead]
NetApp Data Classification supports identity and access management roles to assign roles tailored to the tasks they need to accomplish. How you assign roles depends on your own business and storage management practices.
