...
A _resource_ is an entity that the Console is aware of, such as a storage system, a Console agent, or a Backup and Recovery workload. _Resources_ include storage systems, Keystone subscriptions, as well as Console agents.
