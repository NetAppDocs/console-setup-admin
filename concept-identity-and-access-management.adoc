...
A project grants users access to storage resources. You assign resources to projects and grant users access to projects, not directly to resources. Multiple resources can belong to one project, and a resource can belong to more than one project. You can create multiple projects with their own resources. Granting a user access to a project gives them access to its resources.
...
Storage systems::
Storage systems are the primary resources that you manage in NetApp Console. NetApp Console supports management of both on-premises and cloud storage systems. You must add a storage system to a project so that it can be accessed by those assigned to the project.
