...
[.lead]
Use NetApp Console’s Identity and Access Management (IAM) to structure and control resource access according to your business hierarchy, such as by location, department, or project.

By organizing resources into organizations, folders, and projects, administrators can delegate access precisely, which supports business needs for security, compliance, and operational efficiency.

Within a NetApp Console organization, one or more users is given the responsibility of organizing resources and managing member access. They can create folders and projects to represent the structure of your business and then associate resources with those projects. They can also add members to the organization and assign them roles that define what actions they can perform at specific levels of the resource hierarchy.
