...
NOTE: You must have the _Super admin_, _Organization admin_, or _Folder or project admin_ role to manage IAM in the NetApp Console.
...
You can also verify your organization to link it with your NetApp business account identity for consistent governance across NetApp systems. link:concept-verified-organization.html[Learn about verified organizations in NetApp Console].
