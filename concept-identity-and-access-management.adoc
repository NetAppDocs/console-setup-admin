...
NetApp Console provides granular roles that adhere to the principles of "least privilege" which means access roles are designed to give users access to only that they need
...
You can implement different IAM strategies in NetApp Console depending on your organization's size, structure, and access requirements. The following examples illustrate various approaches to organizing your IAM system.
