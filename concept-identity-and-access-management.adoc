...
Group related projects with folders to organize them by location, site, or business unit. You cant associate resources directly with folders, but assigning a user a role at the folder level gives them access to all projects in that folder.
