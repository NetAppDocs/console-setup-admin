...
summary: Subscribe to NetApp Intelligent Services from your cloud provider's marketplace to pay for NetApp data services at an hourly rate or through an annual contract. If you purchased a license from NetApp, you also need to subscribe to the marketplace offering. Your license is always charged first, but you'll be charged at the hourly rate if you exceed your licensed capacity or if the license's term expires.
---

= Subscribe to NetApp Intelligent Services in NetApp Console restricted mode
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
You must have already deployed a Console agent to subscribe to data services. You need to associate a marketplace subscription to the cloud credentials connected to a Console agent.
