...
= Learn about Google Cloud projects and permissions in NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
. You need to deploy a Console agent using a Google account that has permissions to launch the Console agent from the Console.
