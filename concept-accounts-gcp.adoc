...
* link:task-install-connector-google-bluexp-gcloud.html#agent-permissions-google[Set up Google Cloud permissions for standard mode]
...
* link:task-install-connector-google-bluexp-gcloud.html#agent-permissions-google[Learn how to set up the service account]
