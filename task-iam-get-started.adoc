...
You need *Org admin* or *Super admin* permissions to manage identity and access for your organization. With *Folder or project admin* permissions, you can manage only the folders and projects you have access to.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png[Five] Verify your organization (optional)

[role="quick-margin-para"]
If your team uses organization verification, link your Console organization with your NetApp business account identity.

[role="quick-margin-para"]
link:task-verify-organization.html[Learn how to verify your organization].

.Related information

* link:concept-identity-and-access-management.html[Learn about identity and access management in NetApp Console]
* link:concept-verified-organization.html[Learn about verified organizations in NetApp Console]
