...
=== SSL decryption supported only for Cloud Volumes ONTAP agents

If you use NetApp data services with Cloud Volumes ONTAP, create a dedicated agent for Cloud Volumes ONTAP where you can use a transparent proxy server. Transparent proxy servers are supported for agents associated with Cloud Volumes ONTAP.
