...
If you use NetApp data services with Cloud Volumes ONTAP, create a dedicated agent for Cloud Volumes ONTAP where you can use a transparent proxy server. Transparent proxy servers are supported for agents associated with Cloud Volumes ONTAP. You cannot use a transparent proxy for an agent if it is used with other NetApp data services.
