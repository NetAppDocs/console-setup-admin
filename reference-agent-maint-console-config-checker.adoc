...
summary: You can use the Console agent maintenance console to validate the installation and configuration of a Console agent.
---
...
link:task-install-agent-on-prem.html#os-req-agent[Learn more about host requirements.]
...
`--validationTypes <comma-separated list of validation types to run>` --*REQUIRED*--
...
The following examples include validating network connectivity, required ports, and hardware requirements along with different combinations of using a proxy server and custom certificates.
