...
### NetApp Console Terminology (Critical for Consistency)
- [Category 1: Identity & Access Management (IAM)](#category-1-identity--access-management-iam-terminology-and-hierarchy)
  - 1.1 Hierarchy Terminology
  - 1.2 Role Categories
  - 1.3 Admin Role Distinctions
- [Category 2: Cloud Provider & Networking](#category-2-cloud-provider--networking-conventions)
  - 2.1 Multi-Cloud Parallel Structure
  - 2.2 Cloud-Specific Authentication
  - 2.3 Deployment Modes
- [Category 3: Console Agent Terminology](#category-3-console-agent-terminology-and-operational-concepts)
  - 3.1 Agent Naming Convention
  - 3.2 Agent Capabilities Language
  - 3.3 Agent-Resource Relationships
...
## NetApp Console-Specific Terminology Guidelines
