...
Assign one or more users in both the initiating and receiving organizations  the Partnership admin role to create and manage partnerships. You can assign the Partnership viewer role to users who only need to view partnerships, not manage them.
