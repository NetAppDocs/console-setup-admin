...
Standard mode (SaaS)::
The NetApp Console SaaS (software-as-a-service) application helps organizations manage storage and protect data across hybrid cloud environments. It enables access to all NetApp data services, automated updates, and flexible authentication options such as identity federation and NetApp Support Site logins. This mode supports marketplace subscriptions and BYOL licensing. Businesses can use all features without connectivity limits.
