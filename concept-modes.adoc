...
+
The Console SaaS application does not initiate communication to an agent. The agent initiates all communication and can pull or push data from or to the SaaS application as required.
+
...
| On-premises ONTAP clusters | You can use direct discovery without a Console agent, but you need an agent to use management features.
