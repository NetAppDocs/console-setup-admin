...
= Choose a NetApp Console deployment mode for your business needs
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* Marketplace subscriptions and BYOL are supported with standard mode; however, the supported licensing options depends on which NetApp data service you are using. Review the documentation for each service to learn more about the available licensing options. | N/A
...
* BYOL
+
For Cloud Volumes ONTAP, both capacity-based licensing and node-based licensing are supported with BYOL. | N/A
| Manage cloud provider credentials | N/A 
| Multi-factor authentication (local users) | N/A
| Notifications | N/A
| NSS accounts | N/A
...
* The only supported data sources are the ones that you can discover locally. https://docs.netapp.com/us-en/data-services-classification/task-deploy-compliance-dark-site.html#supported-data-sources[View the sources that you can discover locally^]

* Features that require outbound internet access are not supported. https://docs.netapp.com/us-en/data-services-classification/task-deploy-compliance-dark-site.html#limitations[View the feature limitations^]| Yes
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html#add-unassigned-licenses[Learn how to add licenses^]| N/A
| Identity and access management | N/A
| Manage cloud provider credentials | N/A
| Read-only mode | N/A
| Notifications | N/A
