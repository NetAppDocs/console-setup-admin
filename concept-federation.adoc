...
= Learn about identity federation in NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
NOTE: Federation is not available when NetApp Console is in private mode. link:concept-modes.html[Learn more about NetApp Console modes^].
...
* link:task-federation-adfs.html[Active Directory Federation Services (AD FS)]
* link:task-federation-saml.html[Security Assertion Markup Language (SAML) identity providers]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four] Test your federation in the Console
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png[Five] Enable your connection in the Console
