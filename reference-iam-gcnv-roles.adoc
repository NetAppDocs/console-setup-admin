...
summary: NetApp Console identity and access management provides admin roles that you can assign to the members of your organization who need access to Google Cloud NetApp Volumes.
---
...
Google Cloud NetApp Volumes uses the following roles: 
