...
[.lead]
Get started with the NetApp Console (SaaS) by preparing networking for the Console, signing up and creating an account, and using the NetApp assistant to set up initial functionality.
