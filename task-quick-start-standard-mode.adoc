...
Ensure computers accessing the NetApp console have network access to the required endpoints. If your network restricts outbound access, allow these endpoints.
...
[role="quick-margin-para"]
Sign up for NetApp Intelligent Services through your cloud provider for hourly (PAYGO) or annual billing. A subscription includes NetApp Backup and Recovery, Cloud Volumes ONTAP, NetApp Cloud Tiering, NetApp Ransomware Resilience, NetApp Disaster Recovery, and Data Classification.