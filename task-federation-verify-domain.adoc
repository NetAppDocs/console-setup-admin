...
For example, if using Microsoft Entra ID, you can follow the steps in the Microsoft documentation link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain[Add a domain with Microsoft Entra ID].
