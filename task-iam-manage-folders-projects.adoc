...
The Console automatically creates one project for you when you create a new organization. Most organizations need more than one project, as well as folders to keep things organized. link:concept-identity-and-access-management.html[Learn about the resource hierarchy in NetApp Console].
...
Org admins can delegate administrative responsibilities by creating folders. After creating a folder, an Org admin can assign a member the Folder or project admin role for particular folders. These members can then manage all projects within that folder without having access to the entire organization.
