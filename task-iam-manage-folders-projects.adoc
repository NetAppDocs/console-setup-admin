...
Folders also enable you to manage member access more efficiently. Folders help you manage member access. Assign roles to members at the folder level so all child projects and folders inherit those roles. This makes access management easier in large organizations.
