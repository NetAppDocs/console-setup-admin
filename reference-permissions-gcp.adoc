...
| compute.disks.create .7+|To create and manage disks for Cloud Volumes ONTAP. | ✅ Yes | ❌ No | ❌ No
| compute.disks.createSnapshot | ❌ No | ❌ No | ❌ No
| compute.disks.delete | ❌ No | ❌ No | ✅ Yes
| compute.disks.get | ❌ No | ✅ Yes | ❌ No
| compute.disks.list  | ❌ No | ✅ Yes | ❌ No
| compute.disks.setLabels | ❌ No | ✅ Yes | ❌ No
...
| compute.firewalls.get  | ❌ No | ✅ Yes | ❌ No
| compute.firewalls.list  | ❌ No | ✅ Yes | ❌ No
| compute.globalOperations.get .| To get the status of operations. | ❌ No | ✅ Yes | ❌ No
...
| compute.instances.get | To list VM instances. | ❌ No | ❌ No | ❌ No
| compute.instances.getSerialPortOutput | To get console logs. | ❌ No | ❌ No | ❌ No
| compute.instances.list | To retrieve the list of instances in a zone. | ❌ No | ❌ No | ❌ No
...
| compute.instances.setMachineType .2+| To change the machine type for Cloud Volumes ONTAP. | ✅ Yes | ❌ No | ❌ No
| compute.instances.setMinCpuPlatform | ❌ No | ❌ No | ❌ No
| compute.instances.setMetadata | To add metadata. | ✅ Yes | ❌ No | ❌ No
| compute.instances.setTags | To add tags for firewall rules. | ✅ Yes | ❌ No | ❌ No
...
| compute.snapshots.create .5+| To create and manage persistent disk snapshots. | ✅ Yes | ❌ No | ❌ No
| compute.snapshots.delete | ❌ No | ❌ No | ✅ Yes
| compute.snapshots.get | ❌ No | ✅ Yes | ❌ No
| compute.snapshots.list  | ❌ No | ✅ Yes | ❌ No
| compute.snapshots.setLabels  | ❌ No | ✅ Yes | ❌ No
| compute.networks.get .9+| To get the networking information needed to create a new Cloud Volumes ONTAP virtual machine instance. | ✅ Yes | ❌ No | ❌ No
| compute.networks.list  | ✅ Yes | ❌ No | ❌ No
| compute.regions.get  | ✅ Yes | ❌ No | ❌ No
| compute.regions.list | ✅ Yes | ❌ No | ❌ No
| compute.subnetworks.get  | ✅ Yes | ❌ No | ❌ No
| compute.subnetworks.list   | ✅ Yes | ❌ No | ❌ No
| compute.zoneOperations.get   | ✅ Yes | ❌ No | ❌ No
| compute.zones.get |   ✅ Yes | ❌ No | ❌ No
| compute.zones.list |  ✅ Yes | ❌ No | ❌ No
...
| resourcemanager.projects.get | To support multi-projects. | ✅ Yes | ❌ No | ❌ No
| storage.buckets.create .5+| To create and manage a Google Cloud Storage bucket for data tiering. | ✅ Yes | ❌ No | ❌ No
| storage.buckets.delete |  ✅ Yes | ❌ No | ✅ Yes
...
| compute.instances.setServiceAccount .6+| To set a service account on the Cloud Volumes ONTAP instance. This service account provides permissions for data tiering to a Google Cloud Storage bucket. | ✅ Yes | ❌ No | ❌ No
| iam.serviceAccounts.actAs   | ✅ Yes | ❌ No | ❌ No
| iam.serviceAccounts.getIamPolicy |  ✅ Yes | ❌ No | ❌ No
| iam.serviceAccounts.list   | ✅ Yes | ❌ No | ❌ No
| storage.objects.get |   ✅ Yes | ❌ No | ❌ No
| storage.objects.list |   ✅ Yes | ❌ No | ❌ No
