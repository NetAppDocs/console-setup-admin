...
The `compute.forwardingRules.update` permission is added enabling conversion of existing Cloud Volumes ONTAP systems from Google Cloud Deployment Manager to Google Cloud Infrastructure Manager.
