...
The Console agent makes the following API requests for NetApp Disaster Recovery for Google Cloud NetApp Volumes:

//tag::disaster-recovery-permissions-gcnv[]
...
//end::disaster-recovery-permissions-gcnv[]

The Console agent makes the following API requests for NetApp Disaster Recovery for VMware Engine Service:

//tag::disaster-recovery-permissions-vmes[]
...
//end::disaster-recovery-permissions-vmes[]
