...
| *config.deployments.create* |  | Yes | Yes | No
| *config.deployments.delete* |  | Yes | Yes | No?
| *config.deployments.deleteState* |  | Yes | No | No
| *config.deployments.get* |  | Yes | No | No
| *config.deployments.getState* |  | Yes | No | No
| *config.deployments.list* |  | Yes | No | No
| *config.deployments.lock* |  | No | Yes | No
| *config.deployments.update* |  | Yes | Yes | No
| *config.deployments.updateState* |  | Yes | No | No
| *config.operations.get* |  | No | Yes | No
| *config.previews.get* |  | Yes | No | No
| *config.previews.list* |  | Yes | No | No
| *config.resources.list* |  | Yes | No | No
| *config.revisions.get* |  | Yes | Yes | No
...
| *compute.forwardingRules.create* |  | No | Yes | No
| *compute.forwardingRules.delete* |  | No | Yes | No
| *compute.forwardingRules.get* |  | No | Yes | No
| *compute.forwardingRules.setLabels* |  | No | Yes | No
| compute.globalOperations.get | To get the status of operations. | Yes | Yes | No
| *compute.healthChecks.create* |  | No | Yes | No
...
| *compute.instances.use* |  | No | Yes | No
...
| *compute.resourcePolicies.create* |  | No | Yes | No
...
| *logging.logEntries.route* |  | No | Yes | No
...
| *compute.addresses.createInternal* |  | No | Yes | No
| *compute.addresses.deleteInternal* |  | No | Yes | No
| *compute.addresses.useInternal* |  | No | Yes | No
...
=== 08 December 2025
NetApp is moving from Google Cloud Deployment Manager to Google Cloud Infrastructure Manager (IM), and as such deploying and running an agent in Google Cloud requires different permissions. You must add some permissions for IM. 
