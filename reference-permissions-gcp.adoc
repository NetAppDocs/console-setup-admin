...
The `compute.forwardingRules.update` and `cloudbuild.builds.get` permissions are added to facilitate SVM-based management of the Cloud Volumes ONTAP systems converted from Google Cloud Deployment Manager to Google Cloud Infrastructure Manager.
