...
- *CAN THE BELOW PERMISSIONS BE DELETED?*
...
- *CAN THE ABOVE PERMISSIONS BE DELETED?*
...
| To deploy the Cloud Volumes ONTAP virtual machine instance using Google Cloud Deployment Manager. *SHOULD THE ABOVE SECTION BE REMOVED?*
...
| *To deploy and manage Cloud Volumes ONTAP virtual machine instances using Google Cloud Infrastructure Manager.*
...
| *To create and manage load balancing forwarding rules for Cloud Volumes ONTAP HA pairs.*
...
| *To create and manage health checks for Cloud Volumes ONTAP HA pairs.*
