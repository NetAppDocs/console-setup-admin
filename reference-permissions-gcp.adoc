...
| cloudbuild.workerpools.list | To access worker pool information during private mode deployment of Cloud Volumes ONTAP systems using Infrastructure Manager. | Yes | No | No
