...
[.lead]
Deploy a Console agent using the NetApp Console, your cloud provider's marketplace, or by manually installing software on a Linux host. Your deployment method determines your control over the host and how quickly you can start.
