...
= Manually deploy a Console agent on-premises
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
.Minimum required endpoints (always required)
--
These endpoints are required for all Console agent deployments. Additional endpoints are required when to manage NetApp resources in AWS or Azure.
...
--
When the Console agent is installed on-premises, it needs network access to the following additional AWS endpoints in order to manage NetApp systems (such as Cloud Volumes ONTAP) deployed in AWS.
...
--
When the Console agent is installed on-premises, it needs network access to the following additional Azure endpoints in order to manage NetApp systems (such as Cloud Volumes ONTAP) deployed in Azure.
