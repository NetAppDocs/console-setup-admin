...
.NetApp endpoints (always required)
--
These endpoints are required for all Console agent deployments. Additional endpoints are required when you deploy in AWS or Azure.
...
.Additional endpoints for AWS deployments
--
...
.Additional endpoints for Azure deployments
--
