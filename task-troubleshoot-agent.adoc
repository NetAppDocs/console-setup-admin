...
== Verify network and port access for the Console agent
...
Run configuration checks on Console agents from the Console or or the Agent maintenance console to make sure they can access required endpoints and the required ports are open. 

You can also run configuration checks using the agent maintenance console. link:reference-agent-maint-console-config-checker.html[Learn more about using the config-checker validate command.]
