...
To run configuration checks from the Agent maintenance console, link:reference-agent-maint-console-config-checker.html[learn more about using the config-checker validate command.]
