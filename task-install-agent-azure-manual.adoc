...
= Manually install the NetApp Console agent in Azure
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* link:concept-agent-install-options.html#agent-cloud-manual-deploy[Learn when to deploy manually in Azure].
