...
[.lead]
To use NetApp Console features and services, you'll need to provide permissions so that the Console agent can perform operations in your cloud environment. Use the links on this page to quickly access the permissions that you need based on your goal.
...
| The user who creates a Console agent from the Console needs specific permissions to deploy the agent in AWS.
...
| When the Console deploys a Console agent, it attaches a policy to the agent that provides the permissions required to manage resources and processes in your AWS account.
