...
* For new Console agent deployments from the Console or using https://docs.netapp.com/us-en/netapp-automation/automate/overview.html[Terraform scripts^], IMDSv2 is enabled by default on the EC2 instance.
