...
= Require the use of IMDSv2 on Amazon EC2 instances in NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* For new Console agent deployments from the Console or using https://docs.netapp.com/us-en/console-automation/automate/overview.html[Terraform scripts^], IMDSv2 is enabled by default on the EC2 instance.
