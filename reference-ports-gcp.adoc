...
summary: The Google Cloud firewall rules for the agent require both inbound and outbound rules. The NetApp Console automatically creates this security group when you create a Console agent from the Console. For other installation options, you need to set up this security group manually.

---

= NetApp Console agent firewall rules in Google Cloud
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Google Cloud firewall rules for the agent require both inbound and outbound rules. The NetApp Console automatically creates this security group when you create a Console agent from the Console. For other installation options, you need to set up this security group manually.
...
[cols="20,20,60",options="header",width=70%]
|===
...
| DNS | UDP	| 53 | DNS | Used for DNS resolution by Data Classification
