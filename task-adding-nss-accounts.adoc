...
+
Using this option prompts you to log in again. Note that the token for these accounts expires after 90 days. A notification will be posted to alert you of this.
