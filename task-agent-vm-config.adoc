...
== Apply NetApp security fixes to the OS
NetApp provides security fixes for the underlying operating system of the Console agent. When a new security fix is released, you can apply it to your agent VM using the maintenance console.
