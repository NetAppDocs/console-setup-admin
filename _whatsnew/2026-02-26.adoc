...
| NetApp Backup and Recovery | 5.0.3 (2 March 2026)| Go to the https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html[what's new in NetApp Backup and Recovery page^].


| NetApp Data Classification | 1.5.1 (9 February 2026)| Go to the https://docs.netapp.com/us-en/data-services-data-classification/whats-new.html[what's new in NetApp Classification page^].
