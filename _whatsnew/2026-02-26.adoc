...
| Console agent | 4.4.0 | Go to the https://docs.netapp.com/us-en/console-setup-admin/whats-new.html[What's new in NetApp Console page^] and refer to the changes included for versions 3.4.0.


| Backup and recovery | 5.0.0 (9 February 2026)| Go to the https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html[what's new in NetApp Backup and Recovery page^].
