...
==== NetApp assistant
The NetApp Console Assistant guides first-time administrative users through tasks like deploying agents, discovering clusters, and adding licenses. This onboarding assistant reduces setup time and reduces configuration errors, enabling you to quickly realize value from NetApp Console.
