...
image:https://docs.netapp.com/us-en/console-setup-admin_console/screenshot-storage-menu.png[A screenshot of the Storage menu.]
...
https://review.docs.netapp.com/us-en/console-setup-admin_console-release/media/screenshot-storage-mgmt.png
...
image:https://docs.netapp.com/us-en/console-setup-admin/media/screenshot-storage-mgmt.png[A screenshot that shows the icon to select a Console agent.]
