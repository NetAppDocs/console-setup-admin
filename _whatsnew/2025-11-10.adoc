...
When manually installing a Console agent, the agent now supports RHEL 9.6 with Podman 5.4.0. In addition, when using RHEL 9 and higher, NetApp supports podman-compose 1.5.0. link:https://docs.netapp.com/console-setup-admin/task-install-agent-onprem.html[View operating system requirements].
