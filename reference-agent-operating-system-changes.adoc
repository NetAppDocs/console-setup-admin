...
.Standard mode
--
* https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html[Install and set up a Console agent on-premises]
* https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-aws-manual.html[Manually install the Console agent in AWS]
* https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-azure-manual.html[Manually install the Console agent in Azure]
* https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-google-manual.html[Manually install the Console agent in Google Cloud]
--

.Restricted mode
--
https://docs.netapp.com/us-en/console-setup-admin/task-prepare-restricted-mode.html[Prepare for deployment in restricted mode]
--
...
* https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-create-fsx-working-environment.html[Create or discover an FSx for ONTAP system^]
