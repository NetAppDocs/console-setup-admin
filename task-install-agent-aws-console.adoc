...
summary: You can deploy a Console agent in AWS directly from the NetApp Console. Before deploying a Console agent in AWS from the Console, you need to set up your networking and prepare AWS permissions.
---

= Deploy a Console agent in AWS from NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
You can deploy a Console agent in AWS directly from the NetApp Console. Before deploying a Console agent in AWS from the Console, you need to set up your networking and prepare AWS permissions.
...
Create the Console agent directly from the Console web-based console.
...
. On the *Introduction* page, review the overview of the process.
...
. On the *Network* page, specify a VPC, subnet, and key pair for the agent, choose whether to enable a public IP address, and optionally specify a proxy configuration.
+
