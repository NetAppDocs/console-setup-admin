...
= Manage partnership members in NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
.Required roles
The *Partnership admin* role is required to create and manage partnerships. The *Partnership viewer* can view the Partnerships page. link:reference-iam-predefined-roles.html[Learn more about access roles.]

You can remove users from a partnership at any time. Removing a user from a partnership immediately revokes their access to any resources in the partner organization.
...
. Select the actions menu image:icon-action.png[an icon with three vertical dots] next to the established partnership that you want to add members to and select *Add members*.

. Choose one or more members to add to the partnership and select *Add*.

== Remove members from a partnership

You can remove members from a partnership at any time. Removing a user from a partnership immediately revokes their access to any resources in the partner organization.
...
. Select the actions menu image:icon-action.png[an icon with three vertical dots] next to the member that you want to remove and select *Remove association*.
