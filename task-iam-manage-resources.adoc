...
== Associate an agent with a folder or project
You can associate a Console agent with a project to enable resource management and data service access. Resources discovered through a Console agent require both the resource and agent to be associated with appropriate projects for team access.

NOTE: Only Org admins and Super admins can create and view Console agents. However, Folder or project admins can view and associate an existing agent with a project within their folder.
...
. Navigate to an agent in the table, select image:icon-action.png["An icon that is three side-by-side dots"] and then select *Associate to folder or project*.

. Choose a project or a folder or project and then select *Associate agent*.
