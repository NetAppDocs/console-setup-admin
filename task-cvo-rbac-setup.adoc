...
. Assign a Cloud Volumes ONTAP role to a user at the organization, folder, or project level where the system will be managed. If a member also needs to administer Console resources and assign access to others, assign the appropriate platform role.
