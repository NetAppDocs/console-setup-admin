...
. Review the Cloud Volumes ONTAP role assigned to each user and confirm that it is assigned at the organization, folder, or project level containing the system. link:reference-iam-cvo-roles.html#seeding-mappings-for-existing-users[Learn about the Cloud Volumes ONTAP roles that are assigned automatically after upgrading].
