...
= Deploy a NetApp Console agent from Google Cloud
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
To deploy a Console agent in Google Cloud by using Google Cloud, you need to set up your networking, prepare Google Cloud permissions, enable Google Cloud APIs, and then deploy the Console agent.
