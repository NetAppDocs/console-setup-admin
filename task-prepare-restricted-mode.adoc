...
= Prepare for deployment in NetApp Console restricted mode
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
a| * Your web browser connects to these endpoints for centralized user authentication through the NetApp Console.

include::_include/endpoints-agent.adoc[tag=upgrade-endpoints-restricted]
...
include::_include/endpoints-agent.adoc[tag=azure-gov-endpoints]
