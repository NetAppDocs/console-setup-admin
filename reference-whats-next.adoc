...
= Next steps for NetApp Console in standard mode
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Now that you've logged in and set up the NetApp Console in standard mode, users can create and discover storage systems and use NetApp data services.
