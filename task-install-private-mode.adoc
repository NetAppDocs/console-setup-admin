...
= Deploy the NetApp Console agent in private mode 
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* Select the version that supports private mode. Check the link:whats-new.html[release notes] for the latest supported version.
* Download the offline installer for networks without internet access.
...
--
Provide the Console agent with the credentials for the Azure service principal that you previously set up.
