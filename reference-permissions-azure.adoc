...
= Azure permissions for the NetApp Console agent
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
.3+| Use Virtual Machine Scale Sets in Flexible orchestration mode to specify specific zones for Cloud Volumes ONTAP
