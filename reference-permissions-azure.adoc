...
The following JSON example demonstrates a custom role for Backup and Recovery that uses the fewest possible permissions and the narrowest possible scope:
