...
summary: Uninstall a Console agent to troubleshoot issues or to permanently remove it from the host. The steps that you need to use depend on the deployment mode that you're using. Once you have removed a Console agent from your environment, you can remove it from the Console.
---

= Uninstall and remove a NetApp Console agent
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Uninstall a Console agent to troubleshoot issues or to permanently remove it from the host. The steps that you need to use depend on the deployment mode that you're using. Once you have removed a Console agent from your environment, you can remove it from the Console.
