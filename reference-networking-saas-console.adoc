...
NOTE: Starting with version 4.0.0, Console agents require fewer endpoints. Existing deployments before 4.0.0 remain supported. After upgrading to 4.0.0 or later, you may remove the old endpoints from your allow list when convenient. link:reference-networking-saas-console-previous.html[Learn how to update your endpoint list.]
