...
. On the Customize template window, complete the following fields:
...
** Skip config check: This is unchecked by default. Mark this checkbox if you want to install without running a configuration check.
