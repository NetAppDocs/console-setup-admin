...
= Deploy a Console agent on-premises using VCenter
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
NOTE:  You can't manage resources in Google Cloud with an Console agent installed on your premises. To manage Google Cloud resources, install an agent in Google Cloud.
