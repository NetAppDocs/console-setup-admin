...
** *Hostname*: Define the hostname to use for this VM. It should should be a fully qualified domain name (FQDN) and *not* include the search domain. For example, an FQDN of console10.searchdomain.company.com should be entered as console10.
