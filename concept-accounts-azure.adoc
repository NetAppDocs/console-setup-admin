...
image:diagram_permissions_multiple_azure.png["A conceptual image that shows the initial Azure account that receives permissions through a custom role and managed identity andtwo additional accounts that receive permissions through a custom role and service principal."]
