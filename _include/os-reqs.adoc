...
+
The Console agent requires this space in `/var` because Podman or Docker is architected to create the containers within this directory. Specifically, they will create containers in the `/var/lib/containers/storage` directory and `/var/lib/docker` for Docker. External mounts or symlinks do not work for this space.
//end::dedicated[]
...
| 4.0.0 or later with the Console in private mode 
...
+
The Console agent requires this space in `/var` because Docker or Podman is architected to create the containers within this directory. Specifically, they will create containers in the `/var/lib/containers/storage` directory. External mounts or symlinks do not work for this space.
//end::disk-space[]