...
+
Choose download the agent installer files or copy a URL to the files.
...
NOTE: If you want to configure a transparent proxy, you can do so after you've installed an agent. link:reference-agent-maint-console-proxy.html[Learn about the agent maintenance console].
