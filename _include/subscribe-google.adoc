...
.. After you're redirected to the https://console.cloud.google.com/marketplace/product/netapp-cloudmanager/cloud-manager[NetApp Intelligent Services page on the Google Cloud Marketplace^], ensure that the correct project is selected in the top navigation menu.
+
