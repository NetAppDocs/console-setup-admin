...
| Endpoints
| Purpose
| \https://mysupport.netapp.com | For licensing and contacting NetApp Support.
| \https://signin.b2c.netapp.com | For licensing and contacting NetApp Support. (this endpoint is the CNAME URL for \https://mysupport.netapp.com)
...
If you install the Console agent in a commercial region or sovereign region, the installer needs access to these endpoints:
...
** The endpoints listed in option 1 are supported starting with the 3.9.47 release of the Console agent. There is no backward compatibility with previous releases of the Console agent.
