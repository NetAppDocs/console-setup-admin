...
.. Finish the remaining steps to create the service account.
+
...
. If you plan to deploy Cloud Volumes ONTAP systems in projects other than the project where the Console agent resides, then you'll need to provide the Console agent's service account with access to those projects.
+
