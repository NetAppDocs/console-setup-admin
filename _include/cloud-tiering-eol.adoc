...
NetApp recommends that customers work with their NetApp representative to transition their existing tiering licenses to ONTAP FabricPool licenses, which provide the functionality for data tiering in ONTAP. For more information on how to set up data tiering in ONTAP using FabricPool, see link:https://docs.netapp.com/us-en/ontap/fabricpool/install-license-aws-azure-ibm-task.html[Install a FabricPool license on an ONTAP cluster^].
