...
//tag::upgrade-endpoints-saas[]
a|
* \https://bluexpinfraprod.eastus2.data.azurecr.io
* \https://bluexpinfraprod.azurecr.io 

a| To obtain images for Console agent deployment and upgrades. 



//end::upgrade-endpoints-saas[]


//tag::upgrade-endpoints-restricted[]
a|
For non-Government regions, use the following endpoints:

* \https://bluexpinfraprod.eastus2.data.azurecr.io
* \https://bluexpinfraprod.azurecr.io 

For Government regions, use the following endpoint instead:
...
//Same text is also in endpoints-manual-install--not in use
...
* \https://cloudmanagerinfraprod.azurecr.io
a|
For standard mode and restricted mode non-Government regions, use the following endpoints:

* \https://bluexpinfraprod.eastus2.data.azurecr.io
* \https://bluexpinfraprod.azurecr.io 

For Government regions in restricted mode, use the following endpoint instead:

* \https://occmclientinfragov.azurecr.us 
a| To obtain images for Console agent deployment and upgrades. 
| To obtain images for Console agent deployment and upgrades.
