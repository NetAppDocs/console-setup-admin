...
If you are a VMWare user, you can use an OVA to install a Console agent in your VCenter. link:task-install-agent-on-prem-ova.html[Use VCenter to install an agent.]
