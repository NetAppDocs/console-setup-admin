...
TIP: If you have an existing agent, you should be aware of link:reference-agent-operating-system-changes.html[changes to supported Linux operating systems].
