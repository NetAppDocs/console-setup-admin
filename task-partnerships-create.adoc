...
. Optionally, add organization members to the partnership and select *Apply*.
+
...
.Result
The partnership you approved now shows a status of *Established*. Users with the *Partnership admin* or *Partnership viewer* roles in either organization can view the partnership.
...
. Select either the *Initiated partnerships* or the *Received partnerships* tab.
...
. Select the *Initiated partnerships* tab.
