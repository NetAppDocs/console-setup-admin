...
+
Set up expiry notifications. Choose between seven days or 30 days. Expiry notifications are emailed and shown in the Console to Super admin, Org admin, or Project and folder admin users.
