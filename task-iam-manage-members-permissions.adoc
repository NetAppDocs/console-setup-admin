...
= Add members to a NetApp Console organization
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* You can choose from supported roles when assigning roles to users or service accounts.
...
+
Only supported roles are displayed in the drop-down list. link:reference-iam-predefined-roles.html[Learn about access roles].
