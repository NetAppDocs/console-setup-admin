...
[.lead]
Within the Console, you grant users access to projects or folders to according to a role. A _role_ contains a set of permissions that enables a member (user or service account) to perform specific actions at a specific level of the resource hierarchy. 
