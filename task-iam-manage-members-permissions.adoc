...
[.lead]
Within the Console, you grant users access to projects or folders to according to an access role. A _access role_ contains a set of permissions that enables a member (user or service account) to perform specific actions at the assigned level of the resource hierarchy. 
