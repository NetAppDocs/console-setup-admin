...
[.lead]Within the Console, you grant users access to projects or folders according to an access role. An _access role_ contains a set of permissions that enables a member (user or service account) to perform specific actions at the assigned level of the resource hierarchy. 
...
NOTE: If you are adding a user that is part of a federated group, ensure that the user has already signed up for the NetApp Console and been explicitly assigned a role in the Console. NetApp recommends assigning minimum access role such as Organization viewer.
...
IMPORTANT: When you add a federated group to the Console and assign it a role, only users that are members of the group in your IdP and have already signed up for the NetApp Console and been explicitly assigned a role in the Console can access resources. NetApp recommends assigning minimum access role such as Organization viewer to these users.
