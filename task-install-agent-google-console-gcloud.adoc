...
summary: To create a Console agent in Google Cloud from the NetApp Console or by using Google Cloud, you need to set up your networking, prepare Google Cloud permissions, enable Google Cloud APIs, and then create the Console agent.
---

= Deploy a Console agent in Google Cloud from NetApp Console
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
You can deploy a Console agent in Google Cloud from the Console. You need to set up your networking, prepare Google Cloud permissions, enable Google Cloud APIs, and then deploy the Console agent.

Deploying an agent in Google Cloud launches a VM instance running Linux and the Console agent software in a VPC of your choice.
...
NOTE: When you deploy an agent in Google Cloud, the agent creates a bucket to store deployment files.
...
* A VPC and subnet that meet networking requirements.
...
If you have Google Cloud Storage buckets in the same Google Cloud account where you created the Console agent, a Google Cloud Storage system appears automatically on the *Systems* page. https://docs.netapp.com/us-en/storage-management-google-cloud-storage/index.html[Learn how to manage Google Cloud Storage from the Console^].
