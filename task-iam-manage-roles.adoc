...
= Manage NetApp Console members access
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Manage the access of members in your Console organization. You can update their access permissions by assigning roles based on what they need to do and where. Remove members when they leave your organization.
