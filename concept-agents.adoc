...
You can deploy agents directly from the Console, from your cloud marketplace, or manually in VCenter or on your premises. link:concept-agents-install-options.html[Compare deployment methods to choose the right one for your environment].
