...
+
Some actions require a Console agent or a NetApp Workloads link. https://docs.netapp.com/us-en/storage-management-fsx-ontap/start/concept-fsx-aws.html[Learn which actions require a Console agent or link^]
...
+
https://docs.netapp.com/us-en/storage-management-ontap-onprem/task-discovering-ontap.html[Learn more about discovery and management options for on-premises ONTAP clusters^]
